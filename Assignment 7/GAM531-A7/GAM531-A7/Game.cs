    ...
    public class SpriteAnimationGame : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            _shaderProgram = CreateShaderProgram(); // Compile + link
                                                    // Load all textures
            int idleTex = Texture.LoadTexture("Sprite_Character.png");
            int runTex = Texture.LoadTexture("Owlet_Monster_Run_6.png");
            int jumpTex = Texture.LoadTexture("Owlet_Monster_Jump_8.png");
            ...
            _character.LoadTextures(idleTex, runTex, jumpTex);
...
void main() {
    ...
    // Flip texture horizontally when flipX < 0
